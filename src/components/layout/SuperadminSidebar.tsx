      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-amber-500/30 shrink-0">
        ...
        {!collapsed && (
          <button
            ...
            className="p-1.5 rounded-md text-[var(--sidebar-foreground)] hover:bg-[var(--sidebar-accent)] transition-colors shrink-0"
            aria-label="Collapse"
          >
            <ChevronLeft size={16} />
          </button>
        ...
        {collapsed && (
          <button
            ...
            className="absolute -right-3 top-6 w-6 h-6 rounded-full bg-background border border-border shadow-sm flex items-center justify-center hover:bg-accent transition-colors"
            aria-label="Expand"
          >
